...
module ID (
	...
	//输出：flush_flag_o，分支标志
	//输出：j_target_addr_o，分支目标地址
...
begin
	case(opcode)
		...
		begin
			flush_flag_o	=	1'b1;
			j_target_addr_o	=	b_target_res;
		end
`ifdef ID_JALR
		`OP_JALR:
		begin
			flush_flag_o	=	1'b1;
			j_target_addr_o	=	sum_res;
		end
`endif //ID_JALR
