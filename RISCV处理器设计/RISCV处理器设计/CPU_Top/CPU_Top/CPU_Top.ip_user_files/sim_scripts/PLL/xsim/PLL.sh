...
#
# Generated by Vivado on Thu Jun 16 10:52:40 +0800 2022
...
xv_boost_lib_path=G:/vivado2019.1/Vivado/2019.1/tps/boost_1_64_0
xvlog_opts="--relax"
...
{
  file="xsim.ini"
  lib_map_path="G:/vivado2019.1/Vivado/2019.1/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
